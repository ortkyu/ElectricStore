...
export default function ProductCard() {
  ...
  useEffect(() => {
    fetch(
      `https://electroproduct-f9df8-default-rtdb.firebaseio.com/${router.query.id}.json`
    )
      .then((res) => res.json())
  ...
  let postComment = (exampleRequired) => {
    fetch(
      `https://electroproduct-f9df8-default-rtdb.firebaseio.com/${router.query.id}/comments.json`,
      {
        method: "POST",
